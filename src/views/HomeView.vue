      ...
      <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span class="block text-primary-500">함께 성장하세요</span>
          </h1>
          <p
            class="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl"
          >
            Walk or Run과 함께 운동 데이터를 시각화하고, 다른 사용자들과 함께 챌린지에 참여하며
            동기부여를 받아보세요.
          </p>
          <div class="mx-auto mt-5 max-w-md space-x-4 sm:flex sm:justify-center md:mt-8">
            <BasicButton
